...
#python main.py --model EDSR --epochs 1 --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset
...
#python main.py --model EDSR --scale 4 --save edsr_baseline_x4 --reset
...
#python main.py --data_test Set5+Set14+B100+Urban100 --data_range 801-900 --scale 4 --pre_train '../experiment/edsr_baseline_x4/model/model_best.pt' --test_only --self_ensemble --save_results
...
# CSNET
# Train
#python main.py --template HFASR --epochs 301 --model HFASR --save HFASRX4_G10R20P48 --scale 4 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --reset --patch_size 192
#python main.py --template CSNET --epochs 302 --model CSNET --save CSNETX4_G10R20P48 --scale 4 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --reset --patch_size 192
#python main.py --template CSNET --epochs 300 --model CSNET --save CSNETX3_G10R20P48 --scale 3 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --reset --patch_size 144
#python main.py --template RENWJ --epochs 100 --model RENWJ --save CSNETX2_G10R20P48 --scale 2 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --reset --patch_size 96
#python main.py --template RCAN --epochs 1 --model CSNET --save CSNETX2_G10R20P48 --scale 2 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --reset --patch_size 96
# Tests
python main.py --data_test DIV2K --template RENWJ --model RENWJ --scale 2 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --patch_size 96  --pre_train "../experiment/CSNETX2_G10R20P48/model/model_best.pt" --test_only --save_results

#EHF
#python main.py --template EHF --epochs 300 --model EHF --save EHFX4_G10R20P48 --scale 4 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --reset --patch_size 192
#python main.py --data_test Set5 --template EHF --model EHF --scale 4 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --patch_size 192 --self_ensemble --pre_train "../experiment/EHFX4_G10R20P48/model/model_best.pt" --test_only --save_results

#VDSR
#python main.py --model DDBPN --epochs 100 --scale 4 --batch_size 20 --patch_size 128 --lr 1e-1 --save ddbpn_x4 --reset